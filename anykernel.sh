...
ui_print "开始安装内核..."
ui_print "Powered by GitHub@Numbersf (Aq1298 & 咿云冷雨),二改github@zhiyi0314"
ui_print "(5.10请不要修补kpm大概率会导致卡锁屏无限重启,不慎修补请不要重启,重新刷入内核即可)"
ui_print "(SukiSu不需要susfs模块，默认跳过即可)"
